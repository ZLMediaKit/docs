import{_ as d,a as c}from"./install_zlmediakit_using_vcpkg_2-D4QCkdQ9.js";import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r,c as p,o as u,a as e,b as i,e as a,d as l}from"./app-D6CC-_aF.js";const o={},v={href:"https://github.com/JackBoosY",target:"_blank",rel:"noopener noreferrer"},m={href:"https://github.com/microsoft/vcpkg/blob/master/README_zh_CN.md",target:"_blank",rel:"noopener noreferrer"};function k(b,n){const s=r("ExternalLinkIcon");return u(),p("div",null,[n[5]||(n[5]=e("h1",{id:"简介",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),a(" 简介")],-1)),e("p",null,[n[1]||(n[1]=a("vcpkg 是一个跨平台的 sdk 包管理工具，类似于 linux 下的 yum/apt，macOS 下的 homebrew；它同时支持 linux/macOS/windows 等多个平台，是 c/c++开发者解决依赖的利器。 目前 zlmediakit 已经于 2023-08-08 完成 vcpkg 平台的上线，用户可以通过 vcpkg 便捷安装 zlmediakit c sdk 以及 MediaServer 可执行程序，解决各种编译依赖相关的苦恼。 zlmediakit 上架 vcpkg 得到了")),e("a",v,[n[0]||(n[0]=a("@JackBoosY")),l(s)]),n[2]||(n[2]=a("大量的支持，在此表示由衷的感谢！"))]),n[6]||(n[6]=i(`<h1 id="安装指导" tabindex="-1"><a class="header-anchor" href="#安装指导" aria-hidden="true">#</a> 安装指导</h1><h2 id="_1、安装-vcpkg" tabindex="-1"><a class="header-anchor" href="#_1、安装-vcpkg" aria-hidden="true">#</a> 1、安装 vcpkg</h2><p>以 linux 平台为例：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 下载vcpkg工具</span>
