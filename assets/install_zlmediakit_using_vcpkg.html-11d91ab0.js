import{_ as l,a as c}from"./install_zlmediakit_using_vcpkg_2-aff21ac8.js";import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as r,c as o,a as n,d as e,b as s,e as i}from"./app-684fa53c.js";const p={},u=n("h1",{id:"简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),e(" 简介")],-1),v=n("br",null,null,-1),m=n("br",null,null,-1),b={href:"https://github.com/JackBoosY",target:"_blank",rel:"noopener noreferrer"},k=i(`<h1 id="安装指导" tabindex="-1"><a class="header-anchor" href="#安装指导" aria-hidden="true">#</a> 安装指导</h1><h2 id="_1、安装vcpkg" tabindex="-1"><a class="header-anchor" href="#_1、安装vcpkg" aria-hidden="true">#</a> 1、安装vcpkg</h2><p>以linux平台为例：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 下载vcpkg工具</span>
