import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r,o as i,c as p,a as n,d as a,b as s,e as l}from"./app-4151e1aa.js";const c={},d=n("h2",{id:"前言",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#前言","aria-hidden":"true"},"#"),a(" 前言")],-1),o=n("p",null,"zlmediakit webrtc信令格式新增支持whip/whep标准，测试地址如下：",-1),u={href:"https://zlmediakit.com/index/api/whip?app=live&stream=test",target:"_blank",rel:"noopener noreferrer"},m={href:"https://zlmediakit.com/index/api/whep?app=live&stream=test",target:"_blank",rel:"noopener noreferrer"},v=l(`<p>本文后续篇幅为私有信令格式。</p><h2 id="一、webrtc-sdp交换请求基本格式" tabindex="-1"><a class="header-anchor" href="#一、webrtc-sdp交换请求基本格式" aria-hidden="true">#</a> 一、webrtc sdp交换请求基本格式</h2><ul><li>请求地址: /index/api/webrtc?app=live&amp;stream=test&amp;type=[push/play/echo]</li><li>请求方式: http post</li><li>请求body: webrtc offer sdp</li><li>回复body:</li></ul><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="二、支持的type类型" tabindex="-1"><a class="header-anchor" href="#二、支持的type类型" aria-hidden="true">#</a> 二、支持的type类型</h2><ul><li>push: webrtc推流</li><li>play: webrtc播放</li><li>echo: webrtc镜像回显(仅用于webrtc双向测试)</li><li>用户可以二次开发注册更多类型插件。</li></ul><h2 id="三、范例" tabindex="-1"><a class="header-anchor" href="#三、范例" aria-hidden="true">#</a> 三、范例</h2><ul><li>请求：</li></ul><div class="language-http line-numbers-mode" data-ext="http"><pre class="language-http"><code><span class="token request-line"><span class="token method property">POST</span> <span class="token request-target url">/index/api/webrtc?app=live&amp;stream=test&amp;type=push</span> <span class="token http-version property">HTTP/1.1</span></span>
...
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11);function b(h,k){const e=r("ExternalLinkIcon");return i(),p("div",null,[d,o,n("p",null,[a("推流："),n("a",u,[a("https://zlmediakit.com/index/api/whip?app=live&stream=test"),s(e)])]),n("p",null,[a("拉流："),n("a",m,[a("https://zlmediakit.com/index/api/whep?app=live&stream=test"),s(e)])]),v])}const w=t(c,[["render",b],["__file","webrtc_signaling_interaction_format.html.vue"]]);export{w as default};
