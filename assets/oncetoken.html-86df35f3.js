import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as i,e as t}from"./app-5e987558.js";const s={},l=t(`<p>ZLMediaKit里面大量用到了一个名叫<code>onceToken</code>对象, 很多小伙伴对这个工具类不明就里，下面我在此解释下其作用：<br> onceToken 主要使用C/C++的RAII思想，确保在变量构造和析构时执行自定义代码；主要应用场景有如下：</p><ul><li>1、作为全局变量用，在程序加载时执行特定代码，例如生成默认配置文件：</li></ul><div class="language-C++ line-numbers-mode" data-ext="C++"><pre class="language-C++"><code>////////////HLS相关配置///////////
namespace Hls {
