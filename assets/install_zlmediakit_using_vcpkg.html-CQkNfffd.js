import{_ as l,a as c}from"./install_zlmediakit_using_vcpkg_2-D4QCkdQ9.js";import{_ as d}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o as r,c as p,a as n,d as e,b as s,e as i}from"./app-BTtFj0bM.js";const o={},u=n("h1",{id:"简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),e(" 简介")],-1),v={href:"https://github.com/JackBoosY",target:"_blank",rel:"noopener noreferrer"},m=i(`<h1 id="安装指导" tabindex="-1"><a class="header-anchor" href="#安装指导" aria-hidden="true">#</a> 安装指导</h1><h2 id="_1、安装-vcpkg" tabindex="-1"><a class="header-anchor" href="#_1、安装-vcpkg" aria-hidden="true">#</a> 1、安装 vcpkg</h2><p>以 linux 平台为例：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 下载vcpkg工具</span>
