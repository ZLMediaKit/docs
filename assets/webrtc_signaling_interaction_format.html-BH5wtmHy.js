import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as e,e as s}from"./app-BLv1GOjr.js";const t={},r=s(`<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>zlmediakit webrtc 信令格式新增支持 whip/whep 标准，测试地址如下：</p><p>推流：https://zlmediakit.com/index/api/whip?app=live&amp;stream=test</p><p>拉流：https://zlmediakit.com/index/api/whep?app=live&amp;stream=test</p><p>本文后续篇幅为私有信令格式。</p><h2 id="一、webrtc-sdp-交换请求基本格式" tabindex="-1"><a class="header-anchor" href="#一、webrtc-sdp-交换请求基本格式" aria-hidden="true">#</a> 一、webrtc sdp 交换请求基本格式</h2><ul><li>请求地址: /index/api/webrtc?app=live&amp;stream=test&amp;type=[push/play/echo]</li><li>请求方式: http post</li><li>请求 body: webrtc offer sdp</li><li>回复 body:</li></ul><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
