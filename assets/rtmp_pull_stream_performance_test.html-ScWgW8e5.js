import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,c as r,o as t,a as e,b as d,e as s,d as p}from"./app-D6CC-_aF.js";const m={},u={href:"https://raw.githubusercontent.com/ossrs/srs/develop/trunk/doc/source.200kbps.768x320.flv",target:"_blank",rel:"noopener noreferrer"};function o(c,n){const i=l("ExternalLinkIcon");return t(),r("div",null,[n[12]||(n[12]=e("h2",{id:"一、测试环境",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#一、测试环境","aria-hidden":"true"},"#"),s(" 一、测试环境")],-1)),e("ul",null,[n[2]||(n[2]=e("li",null,"测试日期：2022/5/18",-1)),n[3]||(n[3]=e("li",null,"代码版本：git hash: c7d7999f",-1)),n[4]||(n[4]=e("li",null,"cpu： Intel(R) Xeon(R) Gold 6148 CPU @ 2.40GHz",-1)),n[5]||(n[5]=e("li",null,"操作系统：CentOS release 6.3 (Final)",-1)),n[6]||(n[6]=e("li",null,"内存：16GB",-1)),n[7]||(n[7]=e("li",null,"网卡：127.0.0.1",-1)),e("li",null,[n[1]||(n[1]=s("测试码流: ")),e("a",u,[n[0]||(n[0]=s("200kbps.768x320.flv")),p(i)])]),n[8]||(n[8]=e("li",null,"编译器：gcc (GCC) 8.2.0",-1)),n[9]||(n[9]=e("li",null,"zlmediakit 编译类型：Release",-1)),n[10]||(n[10]=e("li",null,"malloc 库：ptmalloc(未开启 jemalloc)",-1)),n[11]||(n[11]=e("li",null,"config.ini 配置文件修改(主要开启合并写、按需转协议)：",-1))]),n[13]||(n[13]=d(`<div class="language-patch line-numbers-mode" data-ext="patch"><pre class="language-patch"><code>diff --git a/conf/config.ini b/conf/config.ini
